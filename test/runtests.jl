...
polynomial_types = [PolynomialDense{Int,Int}, PolynomialDense{BigInt,Int}] # The types of polynomials to unit test
...
polynomial_types = [PolynomialDense{Int,Int}, PolynomialDense{BigInt,Int}] # The types of polynomials to unit test factorisation
